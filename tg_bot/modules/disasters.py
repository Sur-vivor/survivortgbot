...
WHITELISTLIST_HANDLER = CommandHandler(["whitelistlist"], whitelistlist, filters=CustomFilters.sudo_filter)
SUPPORTLIST_HANDLER = CommandHandler(["supportlist"], supportlist, filters=CustomFilters.sudo_filter)
SUDOLIST_HANDLER = CommandHandler(["sudolist"], sudolist, filters=CustomFilters.sudo_filter)
